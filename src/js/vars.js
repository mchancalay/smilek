export const ca = '7x4FgiFfeqzs1tiUNvJzpt47GtLXAJ8Jfn8G1Hyyu6JH'
export const buyLink = `https://jup.ag/swap/SOL-SMILEK_${ca}`
export const xLink = 'https://x.com/SmileKtothebank';
export const birdeyeLink = `https://birdeye.so/token/${ca}?chain=solana`;
export const telegramENLink = 'https://t.me/+9qvOurhMLbY4ODMx'
export const telegramESLink = 'https://t.me/+1JwjSycsmk8xN2Vh'
export const whitepaperLink = 'https://drive.google.com/file/d/13mBnt-4NtsNYc3fpEAubkonaDu0oUN8j/view'
export const cmcLink = 'https://coinmarketcap.com/es/currencies/bscbet-online/'
...
export const supply =  '2,008,997,929,907 $SMILEK';